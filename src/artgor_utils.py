...
def group_mean_log_mae(y_true, y_pred, types, floor=1e-9):
    ...
    for this competition: https://www.kaggle.com/c/champs-scalar-coupling
    Code is
    from this kernel: https://www.kaggle.com/uberkinder/efficient-metric
    """
...
def train_model_regression(
    ...
    Returns dictionary with oof predictions, test predictions, scores and,
    if necessary, feature importances.
    ...
    :params: plot_feature_importance - whether to plot feature importance
